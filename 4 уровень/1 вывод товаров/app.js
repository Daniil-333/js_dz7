...
function showCategory(category) {
    ...
    if (Object.keys(products).includes(category)) {
        products[category].forEach(function (prodObj) {
            productsDiv.insertAdjacentHTML('beforeend', getProductMarkup(prodObj));
        });
    }
}
...
btnElems.forEach(button => button.addEventListener('click', clickHandler));